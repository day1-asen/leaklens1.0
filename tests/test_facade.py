...
from leaklens.cmdline import main
from leaklens.facade import CrawlerFacade
...
def test_crawler_facade_update_settings(
    ...
    from leaklens.cmdline import facade_obj, facade_settings
...
@pytest.mark.parametrize(
    ...
    # leaklens -u https://meeting.nawaa.com:4433/zh-CN/home -H  -x http://127.0.0.1:8080
    # leaklens -u http://127.0.0.1:8888

)
def test_normal_run(clicker: CliRunner, invoke_args: typing.List[str]):
    from leaklens.util import start_local_test_http_server
